...
(function() {
  ...
  SincFilterInterpolator = (function(_super) {
    ...
    SincFilterInterpolator.prototype.interpolate = function(t) {
      var k, n, sum, _i, _ref, _ref1;
      k = Math.floor(t);
      sum = 0;
      for (n = _i = _ref = k - this.a + 1, _ref1 = k + this.a; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; n = _ref <= _ref1 ? ++_i : --_i) {
      ...
      switch (getType(arr[0])) {
        ...
        case 'Array':
          ...
          interpolators = (function() {
            var _k, _results;
            _results = [];
            for (i = _k = 0; 0 <= dimension ? _k < dimension : _k > dimension; i = 0 <= dimension ? ++_k : --_k) {
          ...
          return function(t) {
            ...
            _results = [];
            for (_k = 0, _len2 = interpolators.length; _k < _len2; _k++) {
