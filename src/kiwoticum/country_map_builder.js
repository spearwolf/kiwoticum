(function(){
    var root = this, _kiwoticum = {};
    if (typeof exports !== 'undefined') {
        if (typeof module !== 'undefined' && module.exports) {
            exports = module.exports = _kiwoticum;
        }
        exports.kiwoticum = _kiwoticum;
    }
    if (!root.kiwoticum) {
        root.kiwoticum = _kiwoticum;
    }


    kiwoticum.CountryMapBuilder = function(container, options) {
