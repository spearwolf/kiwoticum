...
if (phantom.state.length === 0) {
  ...
  setInterval(function() {
    ...
    if(typeof result_el !== 'undefined') {
      try {
        passed = result_el.getElementsByClassName('passed')[0].innerHTML;
        total = result_el.getElementsByClassName('total')[0].innerHTML;
        failed = result_el.getElementsByClassName('failed')[0].innerHTML;
      } catch(e) {
        // SHHHHHH
      }
